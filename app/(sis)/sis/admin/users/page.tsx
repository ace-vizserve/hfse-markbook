    ...
    <PageShell>
      ...
      <header className="space-y-3">
        ...
        <p className="max-w-2xl text-[15px] leading-relaxed text-muted-foreground">
          Invite new staff, change roles, or disable accounts. Parent accounts
          are created by the enrolment portal and aren&apos;t shown here.
          Disabling bans sign-ins but preserves the user record so audit-log
