...
| `key-decisions/markbook.md` | 3, 4, 5, 6, 25, 27, 28, 75, 88, 95, 99, 100, 104 | Grading formula, weights, change-requests, report cards, publishing checklist, change-request hardening, Masterfile + Subject/Overall awards, grading-sheet config sync RPC, non-examinable annual letter grade, non-examinable WW/PT/QA score entry |
| `key-decisions/evaluation.md` | 49, 92, 93, 103 | Form-class-adviser writeups, per-topic 1–5 ratings, teacher-owned topics, PTC feedback + term resolver |
