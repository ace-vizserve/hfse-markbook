...
| `key-decisions/attendance.md` | 47, 50, 55, 76 | Daily attendance writer, school calendar, audience scope |
| `key-decisions/admissions.md` | 17, 18, 51, 59, 61, 62, 69, 70, 77 | Funnel, STP application, chase scope, applicationStatus columns, early-bird AY |
| `key-decisions/pfiles.md` | 31, 34, 36, 60, 63, 64, 71 | Documents repository, upload, revisions, expiry/status, renewal lifecycle, scope guard |
| `key-decisions/records.md` | 37, 40, 48, 66, 67, 68, 72, 83, 85 | Records + SIS Admin: AY rollover, master template, section transfers, late-enrollee, movements, re-alphabetize |
...
- 74 dashboards · 75 markbook · 76 attendance · 77 admissions · 78 dashboards · 79 dashboards · 80 dashboards · 81 dashboards · 82 dashboards · 83 records · 84 ui · 85 records · 87 platform
