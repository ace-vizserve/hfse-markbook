...
| `key-decisions/records.md` | 37, 40, 48, 66, 67, 68, 72, 83 | Records + SIS Admin: AY rollover, master template, section transfers, late-enrollee, movements |
| `key-decisions/parent.md` | 7, 10, 11, 12, 65, 73 | Parent identity, SSO, parent-only surface |

## Quick lookup

KD # → topic file (gaps at 19, 26, 30):
