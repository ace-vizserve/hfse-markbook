...
function buildColumns(ayCode?: string): ColumnDef<OutdatedRow>[] {
  ...
  },
  {
    ...
    header: ({ column }) => <SortableHeader column={column}>Staleness</SortableHeader>,
  ...
  },
  {
    ...
    header: ({ column }) => <SortableHeader column={column}>In pipeline</SortableHeader>,
  ...
  },
  {
    ...
    header: "Mother email",
    cell: ({ row }) => (
      <span className="text-xs text-muted-foreground">{row.original.motherEmail ?? "—"}</span>
    ),
    enableHiding: true,
  },
  {
    ...
    header: "Father email",
    cell: ({ row }) => (
      <span className="text-xs text-muted-foreground">{row.original.fatherEmail ?? "—"}</span>
    ),
    enableHiding: true,
  },
  ];
